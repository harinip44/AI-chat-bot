...
def healthcare_chatbot(user_input):
    ...
    elif "yoga" or "meditation" or "Anxiety" or "nervous" or "tension" in user_input:
        return st.markdown("https://www.youtube.com/playlist?list=PLui6Eyny-Uzwzd-9fi_cmhz3UW9gS1raf","https://www.youtube.com/playlist?list=PLui6Eyny-Uzwzd-9fi_cmhz3UW9gS1raf")
    elif "" in user_input:
        return
    elif "medication" in user_input:
        return
...
def main():
    ...
    if st.button("Submit"):
        if user_input:
            ...
            with st.spinner("Processing your query,just a sec..."):
